...
export default function Question() {
    return (
        <section className=' mt-20 lg:mt-36 md:pt-10  flex flex-col lg:flex-row justify-between items-center bg-[#E8EEE7]  text-black rounded-[20px] lg:min-h-[700px] md:h-fit md:px-6 lg:px-0   lg:mx-6  lg:mt-20 font-normal text-lg   xl:pr-20 text-center md:mt-32 pt-10 py-8'>
